...
Los modelos de la Tabla N° [4.2](#tab:tab-sem) muestra los resultados del modelo de regresión con el factor de atribuciones internas como variable dependiente. Las variables independientes corresponden a los cuatro factores sobre creencias meritocráticas y no meritocráticas, como también a las variables de control.
...
A diferencia de las variables referentes a estratificación social, las variables sociodemográficas mostraron resultados más sólidos en cuanto a significancia. En los modelos 1, 3 y 5 se observa que la variable sexo, con hombre como categoría de referencia, presenta un coeficiente negativo a un 99% de confianza, lo que indica que las mujeres mantienen menos atribuciones internas que los hombres. Esto coincide con lo planteado por la tesis de los desvalidos *o tiene otro nombre? de legitimacioN?* que se observa en algunos trabajos (), en donde el que los hombres mentengan más atribuciones internas funciona para legitimar su superioridad y su propia posición en la jerarquía social. Por su parte, edad presenta un efecto positivo al 99,9% de confianza, lo cual indica que quienes presentan más edad mantienen más atribuciones internas. *explicar porque puede ser | ver si se recodifica por rangos*. Finalmente, en actividad princiapl no se observan efectos significativos, a excepción de la de estudiante, que muestra un efecto negativo pero débil en significancia (95% de confianza), lo que indicaría que aquellos que se encuentran estudiando mantienen menos atribuciones internas respecto de aquellos que se encuentran trabajando con joranada completa o parcial. 
...
<center><p id='tab:tab-sem'> Table 4.2 </p></center>
...
Los modelos de la Tabla N° [4.3](#tab:tab-sem2) muestra los resultados del modelo de regresión, en donde la variable dependiente es el factor de atribuciones externas y las variables independientes corresponden a los cuatro factores sobre creencias meritocráticas y no meritocráticas, como también variables de control.
...
Por último, el modelo 5, en donde se incluyen todas las variables independientes, mantiene los resultados anteriormente descritos relativamente constantes, lo cual indicaría que no existe una alta covarianza entre las variables exógenas. 

<center><p id='tab:tab-sem2'> Table 4.3 </p></center>
