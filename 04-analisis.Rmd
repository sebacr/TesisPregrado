...
```{r matpolycor_indep, echo=FALSE, fig.cap="Matriz de Correlaciones Policlorica para Percepciones y Preferencias meritocráticas", fig.align = 'center', out.width = '100%'}
